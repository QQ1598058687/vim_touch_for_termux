...
" License: MIT
"autocmd FileType cpp nmap <F5> <Esc>:w!<CR>:!compile %<CR>
"autocmd FileType cpp vmap <F5> <Esc>:w!<CR>:!compile %<CR>
"autocmd FileType cpp imap <F5> <Esc>:w!<CR>:!compile %<CR> 
"autocmd FileType cc map <F5> <Esc>:w!<CR>:!compile %<CR>
"autocmd FileType c map <F5> <Esc>:w!<CR>:!compile %<CR>

"< F5> 编译和运行C++
"autocmd FileType cpp nmap <F5> <Esc>:AsyncRun -mode=term g++ -O3 -std=c++17 "%" -o "%<"&&"./%<"<CR>
autocmd FileType cpp nmap <F5> <Esc>:AsyncRun -mode=term g++ -O3 -std=c++17 "%" -o "%<" && "./%<"<CR>
...
"autocmd FileType cpp imap <F5> <Esc>:call CompileRunGpp()<CR>
"autocmd FileType cc map <F5> <Esc>:call CompileRunGpp()<CR>
"autocmd FileType c map <F5> <Esc>:call CompileRunGpp()<CR>
"func! CompileRunGpp()
"exec "w"
"exec "!g++ % -std=c++17 -g -o %<"
"exec "! ./%<"
