...
function install_prepare_software_on_android()
{
    ...
    #安装vim
    tar -zxvf ~/.vimplus/vim-9.0.0619.tar.gz -C ~/
    cd ~/vim-9.0.0619
...
# 安装android平台字体
function install_fonts_and_keyboard_on_android()
{
...
#直接使用最新版本
    ...
    git clone https://github.com/ycm-core/YouCompleteMe --recurse-submodules --branch legacy-c++11 ~/.vim/plugged/YouCompleteMe
...
function install_vimplus_on_android()
{
    ...
    copy_files
    install_fonts_and_keyboard_on_android
